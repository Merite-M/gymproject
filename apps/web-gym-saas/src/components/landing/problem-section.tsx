...
export default function ProblemSection() {
  return (
    <section className="py-24 bg-[#F7F9FC] text-[#0B1F33]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          {/* Card 1: Employees */}
          <div className="bg-white border border-gray-200/80 rounded-[14px] p-8 shadow-sm hover:border-[#28D17C]/50 transition-all duration-200">
        ...
        <div className="text-center pt-4">
          <div className="inline-flex items-center gap-3 bg-white border border-[#28D17C]/30 px-6 py-3 rounded-full shadow-sm">
            <ArrowDown className="w-4 h-4 text-[#28D17C]" />
